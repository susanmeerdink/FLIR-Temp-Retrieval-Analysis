...
handles.treeLoadedFlag = 0; % this initializes the flag for checking if a images has been loaded before running batch process
handles.outputFolderFlag = 0; % this initializes the flag for checking if a images has been loaded before running batch process
